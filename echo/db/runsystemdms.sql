...
-- Membuang data untuk tabel runsystemdms.tblmenu: ~15 rows (lebih kurang)
...
REPLACE INTO `tblmenu` (`MenuCode`, `MenuDesc`, `Parent`, `Param`, `Icon`, `StdInd`, `SpcInd`, `Visible`, `MenuCat`, `CreateBy`, `CreateDt`, `LastUpBy`, `LastUpDt`) VALUES
	...
	('02', 'Bab', NULL, NULL, NULL, 'Y', 'N', 'Y', 'D', 'Yusril', '202010151117', NULL, NULL),
	('0201', 'Generals', '02', NULL, 'MenuApplication', 'Y', 'N', 'Y', 'D', 'Yusril', '202010151117', NULL, NULL),
	('03', 'Sub', NULL, NULL, NULL, 'Y', 'N', 'Y', 'D', 'Yusril', '202010191117', NULL, NULL),
	('0301', 'Acounting', '03', NULL, 'Economy', 'Y', 'N', 'Y', 'D', 'Yusril', '202010191117', NULL, NULL),
	('0302', 'Generals', '03', NULL, NULL, 'Y', 'N', 'Y', 'D', 'Yusril', '202010191117', NULL, NULL);
